...
/**
 * Standard 604-page Uthmani mushaf: start page for each surah (1-114).
 * Index 0 = Surah 1 (Al-Fatiha), Index 113 = Surah 114 (An-Nas).
 */
object MushafSurahPageMapping {
    private val surahStartPage = intArrayOf(
    ...
    /** 1-based surah number (1..114) -> mushaf start page (1..604). */
